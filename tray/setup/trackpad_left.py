...
def build() -> Gtk.Widget:
    ...
    box.pack_start(lbl(
        "Choose how the left trackpad behaves after the transition.",
        "page-body",
    ), False, False, 0)
    ...
    section = radio_section([
        {"label": "Steam scroll wheel",
         ...
         "default": True,
         "no_btn": True},
        {"label":   "Activate Combined Gestures",
         "sub":     "Use both trackpads together for scroll and pinch gestures.",
         "default": False,
